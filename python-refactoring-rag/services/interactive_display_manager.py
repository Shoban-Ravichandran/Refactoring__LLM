    ...
    def _handle_pdf_reprocessing(self):
        ...
        try:
            if self.display_manager.use_rich:
                ...
                should_reprocess = Confirm.ask("This will reprocess all PDFs and regenerate embeddings. Continue?")
            else:
                choice = input("This will reprocess all PDFs and regenerate embeddings. Continue? (y/n): ").lower()
